...
const CONFIG = {
  ...
  excludeSMSLines: ["nonpro sales (post close)", "Jarred Bullard", "Ben Gratza", "Danny Brady", "Beth Ann Hunt", "Soren Dahl", "Brittany Bowles", "Curtis Smith", "Ian Storz", "Brian Broyles"],
